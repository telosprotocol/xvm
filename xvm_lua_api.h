...
static int L_create_key(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "create_key error, key is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_set_key(lua_State *L)
{
    ...
    if (lua_isstring(L, 1) && lua_isstring(L, 2)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "set_key error, key value is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_get_key(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "get_key error, key is not string"};
    }
...
static int L_lcreate(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "lcreate error, key is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_lpush(lua_State *L)
{
    ...
    if (lua_isstring(L, 1) && lua_isstring(L, 2)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "lpush error, key value is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_rpush(lua_State *L)
{
    ...
    if (lua_isstring(L, 1) && lua_isstring(L, 2)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "rpush error, key value is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_lpop(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "lpop error, key is not string"};
    }
    lua_pushstring(L, value.c_str());
    return 1;
}
...
static int L_rpop(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "rpop error, key is not string"};
    }
    lua_pushstring(L, value.c_str());
    return 1;
}
...
static int L_ldel(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "ldel error, key is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_llen(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "llen error, key is not string"};
    }
...
static int L_lall(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "lall error, key is not string"};
    }
    return 1;
}
...
static int L_hcreate(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "hcreate error, key is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_hset(lua_State *L)
{
    ...
    if (lua_isstring(L, 1) && lua_isstring(L, 2) && lua_isstring(L, 3)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "hset error, key, field,value is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_hget(lua_State *L)
{
    ...
    if (lua_isstring(L, 1) && lua_isstring(L, 2)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "hget error, key is not string"};
    }
    lua_pushstring(L, value.c_str());
    return 1;
}
...
static int L_hlen(lua_State *L)
{
    ...
    if (lua_isstring(L, 1)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "hlen error, key is not string"};
    }
    lua_pushnumber(L, iLen);
    return 1;
}
...
static int L_hdel(lua_State *L)
{
    ...
    if (lua_isstring(L, 1) && lua_isstring(L, 2)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "hdel error, key,field is not string"};
    }
    lua_pushnil(L);
    return 0;
}
...
static int L_grant(lua_State *L)
{
    ...
    if (lua_isstring(L, 1) && lua_isnumber(L, 2)) {
        ...
        throw xvm_error{enum_xvm_error_code::enum_vm_exception, "grant error, key must string, value must number"};
    }
    lua_pushnil(L);
    return 0;
}
