...
private:
     ...
     * @return false
     */
    bool upd_reg_contract_read_status(const uint64_t cur_time,
     ...
     *
     * @param is_auditor
     * @param cluster_zero_workload
     * @param shard_zero_workload
     * @param account
     * @param cluster_total_rewards
     * @param clusters_workloads
     * @param workload_reward
     */
    void add_workload_reward(bool is_auditor,
     ...
     * @param cluster_zero_workload
     * @param shard_zero_workload
     * @param auditor_group_count
     * @param validator_group_count
     * @param workload_total_reward
     * @param clusters_workloads
     * @param zero_workload_rewards
     */
    void zero_workload_reward(bool validator,
                              uint32_t const & cluster_zero_workload,
                              uint32_t const & shard_zero_workload,
    ...
    /**
     * @brief void xzec_reward_contract::preprocess_workload(bool is_auditor, std::map<std::string, std::string> & clusters_workloads, std::map<std::string, xreg_node_info> const &
     map_nodes, const uint32_t cluster_zero_workload, const uint32_t shard_zero_workload)
     *
     * @param is_auditor
     * @param clusters_workloads
     * @param map_nodes
     ...
     * @param shard_zero_workload
     */
    void preprocess_workload(bool is_auditor,
     ...
     *
     * @param account
     * @param adv_total_votes
     * @param adv_reward_to_voters
     * @param contract_auditor_votes
     * @param contract_rewards
     * @param contract_auditor_vote_rewards
     * @return true
     * @return false
     */
    bool add_table_vote_reward(std::string const & account,
     ...
     * @param node_reward
     * @param contract_rewards
     * @param table_nodes_rewards
     */
    void add_table_node_reward(std::string const & account,
                               top::xstake::uint128_t node_reward,
                               std::map<std::string, top::xstake::uint128_t> & contract_rewards,
                               std::map<std::string, std::map<std::string, top::xstake::uint128_t>> & table_nodes_rewards);

    /**
     * @brief Get the adv total votes object
     *
     * @param contract_auditor_votes
     * @param account
     * @return uint64_t
     */
    uint64_t get_adv_total_votes(std::map<std::string, std::map<std::string, std::string>> const & contract_auditor_votes, std::string const & account);
