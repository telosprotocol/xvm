...
private:
     ...
     * @param tickets votes
     */
    void update_advance_tickets(common::xaccount_address_t const & advance_account, uint64_t tickets);
     ...
     * @return false
     */
    bool need_upload_vote_data(const uint64_t onchain_timer_round);
