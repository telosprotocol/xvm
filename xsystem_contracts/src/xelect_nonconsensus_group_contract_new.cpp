...
bool xtop_elect_nonconsensus_group_contract_new::elect_group(common::xzone_id_t const & zid,
    ...
    auto const & standby_result = standby_network_result.result_of(node_type);
    ...
    for (auto const & new_node_info : standby_result) {
